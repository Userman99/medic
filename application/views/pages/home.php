      ...
      <div class="tp-banner">
        <ul>
          ...
          <li data-transition="random" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" > 
            <!-- MAIN IMAGE --> 
            <img src="template/html/images/slider-bg-1.jpg"  alt="slider"  data-bgposition=" center center" data-bgfit="cover" data-bgrepeat="no-repeat"> 
            ...
            <div class="tp-caption sfl tp-resizeme" 
                ...
                data-endspeed="300"
                style="z-index: 5; font-size:50px; font-weight:500; color:#fff;  max-width: auto; max-height: auto; white-space: nowrap;">Hallo, Kami Adalah Team Medis!!</div>
            ...
            <div class="tp-caption sfr tp-resizeme" 
                ...
                data-endspeed="300" 
                style="z-index: 6; font-size:40px; color:#fff; font-weight:500; white-space: nowrap;">Kami Peduli Dengan Kesehatan Anda  </div>
            ...
            <div class="tp-caption sfb tp-resizeme" 
                ...
                data-endelementdelay="0.1" 
                data-endspeed="300" 
                style="z-index: 7;  font-size:22px; color:#fff; font-weight:500; max-width: auto; max-height: auto; white-space: nowrap;">Layanan Medis Terbaik di Kota anda </div>
            ...
            <div class="tp-caption lfb tp-resizeme scroll" 
                ...
                data-endspeed="300" 
                data-scrolloffset="0"
                style="z-index: 8;"><a href="#." class="btn">VIEW SERVICES</a> </div>
          </li>
          
          <!-- SLIDE  -->
          <li data-transition="random" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" > 
            <!-- MAIN IMAGE --> 
            <img src="template/html/images/slider-bg-2.jpg"  alt="slider"  data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat"> 
            ...
            <div class="tp-caption sfl tp-resizeme" 
                ...
                data-endelementdelay="0.4" 
                data-endspeed="300"
                style="z-index: 5; font-size:40px; font-weight:500; color:#000;  max-width: auto; max-height: auto; white-space: nowrap;">Layanan Terbaik </div>
            ...
            <div class="tp-caption sfr tp-resizeme" 
                ...
                data-endelementdelay="0.4" 
                data-endspeed="300"
                style="z-index: 5; font-size:55px; font-weight:500; color:#000;  max-width: auto; max-height: auto; white-space: nowrap;">Hallo, Kami Adalah Team Medis!!</div>
            ...
            <div class="tp-caption sfb tp-resizeme" 
                ...
                data-endelementdelay="0.1" 
                data-endspeed="300" 
                style="z-index: 7; font-size:16px; color:#000; font-weight:500; line-height:26px; max-width: auto; max-height: auto; white-space: nowrap;">Kami siap membantu anda dalam urusan kesehatan anda,  Dan kami memberi fitur-fitur untuk memudahkan anda
               <br>
               Baik dalam urusan pemilihan Rumah sakit, puskesmas dan temu janji dokter. </div>
      ...
      <div class="container">
        <div class="intro-main">
          <div class="row"> 
            ...
            <div class="col-md-8">
              <div class="text-sec">
                <h5>Best Medical Responsive HTML5 Multipurpose Template</h5>
          ...
          <div class="row"> 
            ...
            <div class="col-md-4"> 
              ...
              <article class="news-post">
                <div class="post-img"> <img class="img-responsive" src="template/html/images/new-post-img.jpg" alt="">
                  <div class="date"> 08 MAR </div>
                </div>
                <a href="#." class="tittle">The Hospital Department Patient</a> <span class="by">By M_ADNAN</span>
                ...
                <!-- Post Info -->
                <div class="post-info"> <span><i class="fa fa-comments-o margin-right-10"></i>97</span> <span><i class="fa fa-eye margin-right-10"></i>563</span> <span><i class="fa fa-tag margin-right-10"></i>Medical</span> <a href="#.">More <i class="fa fa-angle-right margin-left-10"></i></a> </div>
              </article>
            </div>
            ...
            <div class="col-md-4"> 
              ...
              <article class="news-post">
                ...
                <a href="#." class="tittle">The Department Of Patient</a> <span class="by">By M_ADNAN</span>
                <p>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit random text occaecat cupidatat non proident.</p>
