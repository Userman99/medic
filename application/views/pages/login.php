...
<body style="background-color: #999999;">
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="login100-more" style="background-image: url('template/login/images/bg-01.jpg');"></div>
			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
				<form class="login100-form validate-form" method='POST' action="<?php echo base_url("login/proses_login") ?>">
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						<span class="label-input100">Email atau No Hp</span>
						<input class="input100" type="text" name="username" placeholder="Email atau No Hp.....">
					...
					<div class="container-login100-form-btn">
						...
						<a href="<?php echo base_url("register") ?>" class="dis-block txt3 hov1 p-r-30 p-t-10 p-b-10 p-l-30">
							Sign-up
